...
| **Benefits ownership and funding** | Operational owner: Freston Kenny Adedeme. Measures: **[SPONSOR TO CONFIRM]** — no adoption, conversion, or reliability targets are recorded anywhere in the project; this charter will not invent them. Default Gate 7 date per PM Framework Class A table: 6 months after Gate 6 (interim review at 3 months), once Gate 6 is reached — not yet applicable. Protected review effort: 2 person-days plus measurement cost, per the same table, to be included in the Gate 3 budget once one exists. |
